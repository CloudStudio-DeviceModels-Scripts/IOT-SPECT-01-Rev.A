...
This **Parsing + Configuration** script is designed for the **IOT-SPECT-01** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
Este script de **Parsing + Configuration** está diseñado para el modelo **IOT-SPECT-01** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
